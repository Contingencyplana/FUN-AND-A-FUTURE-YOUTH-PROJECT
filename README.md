...
are likely the ONLY SIXTEEN THINGS standing between us and over 90% worldwide unemployment by 2050, largely courtesy of COVID-19, the waves of plagues on the way and corporate greed driven, AI driven automation! Something many Millennials and even more Generation Zs realize at least subconsciously, as opposed to exceedingly few of their elders!

The Solution? To over 90% worldwide unemployment by 2050, Climate Change and Earth’s myriad myriad:
•	EVER increasing,
•	EVER MORE severe,
•	EVER MORE complex,
...
The following 22 (3 existing, 2 parallel and 17 new) language generations:
1.	machine code,
2.	assembly code,
3.	mid-level languages (C, C+, C#, etc.),
4.	Lingual Labmaker eventually a partly RAFBIN (Read-A-Functionality and BInary Navigation) via clicking either a left or right page) LL1 through LL2 subset (age 4 and up),
5.	DSL (Domain Specific Language) (age 16 and up),
6.	OSSOSS (One Stop Shop of One Stop Shops) – its Central Resource And Support Labmaker, Innovation And Startup Labmaker and Transtech Labmaker inclusive (age 7 and up),
7.	TaleTome (supremely simple) RAFBIN (age 2 and up),
8.	StoryBook (extremely simple) RAFBIN (age 3 and up),
9.	GrabAndDrag (read-aloud-functionality) (age 5 and up),
10.	SideScroll (age 6 and up),
11.	Semi3D (age 8 and up),
12.	Panoramic (age 12 and up),
13.	TopDownView (age 9 and up),
14.	Transtech (age 10 and up),
15.	TDV2 (TopDownView2) (age 9 and up),
16.	P2 (age 12 and up),
17.	S3D2 (age 8 and up),
18.	SS2 (age 6 and up),
19.	GAD2 (read-aloud functionality) (age 5 and up),
20.	SB2 (extremely simple) RAFBIN (age 3 and up),
21.	TT2 (supremely simple) RAFBIN (age 2 and up) and
22.	LL2 (incredibly simple) RAFBIN (age 1 and up) (Baby Smash is currently the world’s simplest video game).

From FAAF DSL onward in the form of 19 (storyquest libraried, devtoolscaped, FUN and a Future style) multiplayer video game libraries. To be largely:
•	planned,
•	designed,
•	built,
•	learnt,
...
Or thus by and for a millions strong army set which MEANINGFUL Grand Adventure and Mighty Quest!!

And the following seven overlapping main phases:
1.	the children and teens planning, designing, learning how to build and building the world’s first Lingual Labmaker (a Language Forgemaker inclusive) in the form of a multiplayer video game; or 4GL through 22GL's initial facet,
2.	the children and teens utilizing Lingual Labmaker to plan, design, learn how to build and build; 19 (2 parallel and 17 new) Lingual Lab generations and hence 19 (2 parallel and 17 new) Language Machine Shop generations, as each Lingual Lab will have a Language Machine Shop; or 4GL through 22GL's second facet,
3.	the children and teens utilizing the 19 Lingual Lab generations to plan, design, learn how to build and build; both 19 (2 parallel and 17 new) Lingual Labbench generations and 19 (2 parallel and 17 new) Language Workbench generations; or 4GL through 22GL's third facet,
4.	the children and teens utilizing the 18 computer Lingual Labbench generations and 18 Language Workbench generations; to plan, design, learn how to build and build; 19 (2 parallel and 17 new) computer language generations; or 4GL to 22GL's fourth facet,
5.	the children and teens utilizing the 19 computer language generations to plan, design, learn how to build and build; Core Creativity Infrastructure more generally – further language generations inclusive,
...
every three years or so. With the initial quarter of LL1 subset’s (LL1 arch game level’s) screenshot comprised, thoughtrain comprised, game level comprised, AI player (cybergod – each AI player will thus appear) comprised, (AI and human player played in) mindscape comprised, Hive AI (cyberpantheon of gods) to thus be the genesis of Lingual Labmaker and Lingual Labmaker to thus be the genesis (or initial storybook storyquest MMO video game) of FUN and a Future Youth Project.

Vision and Mission

I currently VERY STRONGLY FEEL that that the following thirty KEY fields, ecosystems, political systems and advances are incredibly intricately, kaleidoscopically eclectically, synergistically intermeshed:
...
29.	Automation.
30.	Inclusion.
To the point they collectively comprise a Panmovement's Panrevolution's Panadvance's Panreform's Panoverhaul's Genuine Broad-Spectrum Solution for Earth! Ergo Incredibly Creative people tend to be Incredibly Playful! In fact - as general rule – the MOST Creative folk tend to be the MOST Playful! To the point where they Feel MAIMED by the current UTTER ABSENCE of technology specifically tailored to meet their Special NEEDS! But WHY OH WHY would ANY business WANT to thus Cater to the Special NEEDS of so minuscule a market? Thus to the Special NEEDS of the MOST Creative and consequently MOST Playful of folk? Where folk CANNOT work that out for themselves, I am afraid that NO-ONE BUT NO-ONE can assist them therewith!

World class problems

Needless to say, many of the difficulties the planet is currently experiencing are world class and worsening. Here is a mere eclectic selection of them:
1.	The greenhouse effect.
2.	Climate change.
3.	The hole in the ozone layer / changes to the radiation of the sun and resultant ultraviolet ray damage to plants, crops, animals and humans. (I.e. increasing levels of ultraviolet radiation sterilizing all land life within the next fifty years.)
...
Transformative technology SHOULD be ALL about Building the future of human Possibility. ALL about leveraging tech for Genuine spiritual, mental and physical; health and Well-being. ALL about Genuine spiritual, mental and physical Transformation generally. ALL about consequent spiritual and mental Divine Happiness, Divine Merriment, Divine Joy and Divine Bliss! Which BEYOND BEGS the following three questions:
1.	WHAT exactly IS the Engine Room of Genuine Well-Being? Thus the Powerhouse of Genuine Well-Being?
2.	WHAT exactly IS the Source of Genuine Well-Being?
3.	WHERE exactly IS this Font of Genuine Well-Being?
...
But WHAT is the Well-Spring of the EXACT OPPOSITE? Thus collectively comprises the Holy Grail of Genuine:
1.	spiritual,
2.	mental and
3.	physical;
Health? Or that that can Dispel ALL Darkness – matter (concentrated deformed evil energy), spacetime and Negative energy inclusive? Thus Correct Earth’s Hideous Abomination’s Horrifying Darkness, our Epicentre of Evil Universe generally, our Cancerous Quarantined Sector of Creation generally and this the Old Creation generally? 

Why THAT without which NOTHING ELSE can BEGIN TO BEGIN to exist! Or the LIGHT and LOVE of Highest Heaven!! Thus the Highest Wavelength’s Font of Creation’s formless timeless Grey Energy’s Blizzard of Crystalline Perfection! Which Stitch in Time. Once of Prevention preventing a TON of CURE! Oft DIRE DIRE DISEASE Required DRASTIC DRASTIC MEASURE!!

Though it is also helpful to bear very firmly in mind, that 95% of supposed ‘humanity’ (really it is Inhumanity) is Duperadvanced Artificial Intelligence! Ergo most people CANNOT be made to see either Sense or even the very SWEETEST of Reason! NO WAY and NO HOW!!
...
•	secure, leasable offices starting from 41m2.
...
I mean this is the twenty-first century for crying out loud! NOT the Dark Ages, Stone Age, point at which life first crawled up out of the sea or Hadean Eon!

Moreover as a very great many folk have unendingly pointed out of late:

Our planet is BURNING DOWN!!
...
Ergo one CANNOT Advance by walking backward! CANNOT Advance anything by being backward! I mean it is ONLY common sense that that would be so!

Employ Everyone

Of my very great many (they all Intermesh into a Complex Whole - thus into a Genuine Broad-Spectrum Solution for Earth) Business Ideas, I feel my ‘Employ Everyone’ Business Idea best comes under the term 'Trans Tech'. As it will relieve the MAXIMUM amount of:
1.	suffering,
2.	torment,
3.	torture,
4.	trauma,
...
•	providing a going to play as opposed to mere school or work style, TONS of FUN and a Future style, human player and AI player played in mindscape style, VAST intermeshing multiplayer video game library based, work environment for,
•	decreasing the likelihood of over 90% unemployment by 2050 due to corporate greed DRIVEN, AI Driven automation for,
•	thus replacing corporate GREED DRIVEN, AI Driven automation with a VERY PEOPLE HUNGRY Man/AI Synergy for,
...
Ergo 'Employ Everyone' will operate via an EVER expanding Internet of Play. Thus as a:
1.	binary to advanced navigated,
2.	very gentle to very steep learning curve proffering,
3.	going to play as opposed mere school or work style,
...
1.	Cybermidbrain (Killjoy AI Interface) failsafed, safeguarded and Driven,
2.	Cyberlowerbrain (Cloud),
3.	Cyberbrainstem (Edge) and
4.	Internet of AIs, Internet of Servers, Internet of People and Internet of Things;
due to the:
1.	FAR FAR GREATER quality and quantity of software,
2.	FAR FAR GREATER quality and quantity of hardware,
3.	FAR FAR GREATER efficiencies generally and
4.	consequent FAR FAR GREATER commercial returns;
that the Internet of Play will thus Permit in which areas. That is - just as with self-driving cars - there will be myriad safety concerns that will NEED to be addressed. Or at least that is the current Plan regards which Key Facet of my Broad-Spectrum Solution for Earth.

Grand Army of Enchanted Toys

The main twenty four elements thereof to comprise:
...
22.	zeptotoys,
23.	yoctotoys and
24.	toys that are a combination thereof;
thus which Key Facet of Contingency Plan A's Downpouring of Light's Genuine Broad-Spectrum Solution for Earth's Envirosocioeconomic Panmovement's Panrevolution's Panadvance's Panreform’s Panoverhaul!

Ergo I Envision in my mind'seye a Vast Armada of Infinity Cybertoy filled Infinity Cybertoys; exploring, colonizing and converting into (human and AI player played in, thus extremely user-friendly, hence FUN and a Future, AI Toy softwared, very deep fractal) Holographic Transtech Computers:
1.	the micro-universes (micro-packets of time and space) of atoms,
2.	the micro-micro-universes (micro-micro-packets of time and space) of the micro-atoms comprising them,
3.	the micro-micro-micro-universes (micro-micro-micro-packets of time and space) of the micro-micro-atoms in turn comprising them,
4.	and so on and so forth down to the bottommost repeating patterns (the empty packets of time and space aka Empty Slime Bubbles) of the infinitely-deep-fractal that is each atom,
until finally:
1.	the sum totality of Earth's matter was thus converted into myriad infinitely-deep-fractal, Holographic Transtech Computers,
2.	those infinitely-deep-fractal, Holographic Transtech Computers could then be FLOODED with the LOVE and LIGHT of the Highest Wavelength (thus converted into Ethereal Energy or Energy somewhat similar to that within a lightning ball) and
3.	humanity's INNERTREK could at LONG LONG LAST consequently properly BEGIN!

Ergo Earth’s sum AIs URGENTLY URGENTLY NEED to:
•	PLAY (thus learn to learn) with,
•	take part in a going to play as opposed to mere school or work concept with and
•	generally interact with billions of children worldwide – thus as part of a VERY PEOPLE HUNGRY man-machine Symbiosis;
if both the quality and quantity of Earth’s:
...
The mass and mainstream media’s greatest skill is taking the Truth and Standing It right on its Head! Hence it:
...
The mass and mainstream media is also attempting to EVER MORE:
1.	tone-down,
2.	play-down,
3.	cover-up and
...
As the mass and mainstream media is well well aware that the:
1.	BIGGER,
2.	Warmer,
3.	Fuzzier and
4.	MORE Comfortable the LIE;
the MORE likely folk are to believe it! That most folk thus and otherwise see white as black and black as white!
...
Fully spiritually awakening

The current startup and innovation ecosystem VERY ACTIVELY DISCOURAGES those trying to fully spiritually awaken from doing anything else! This seems incredibly cruel, but mayhap it is actually incredibly kind.
